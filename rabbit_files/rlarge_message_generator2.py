...
exchange_name = "my_exchange_2"  # Name of the exchange to publish messages to
routing_key = "key2.topic2"

# Establish connection to RabbitMQ server
# Access credentials ('Username', 'Password'), be sure to add creds to rabbit config
connection_parameters = ConnectionParameters(host=rabbitmq_host, port=5672, credentials=pika.PlainCredentials('', ''))  
