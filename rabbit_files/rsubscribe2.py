...
exchange_name = "my_exchange_2"  # Name of the exchange to consume from (matches producer)
...
channel.queue_declare(queue="queue_2_1", durable=True)

# Consume messages from the exchange with the specified routing key
channel.basic_consume(queue="queue_2_1",  # Specify the queue name
